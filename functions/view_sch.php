...
function scholarDisplay($currentPage = 1, $recordsPerPage = 15, $search = '', $sortColumn = 'batch_num', $sortOrder = 'DESC') {
    global $conn;
    ...
    $validColumns = ['batch_num', 'scholar_id', 'last_name', 'first_name', 'middle_name', 'status'];
    $validOrders = ['ASC', 'DESC'];
    $sortColumn = in_array($sortColumn, $validColumns) ? $sortColumn : 'batch_num';
    $sortOrder = in_array(strtoupper($sortOrder), $validOrders) ? strtoupper($sortOrder) : 'DESC';
