...
//* DOCUMENT DISPLAY - SCHOLAR *//
	function docxDisplay($id, $currentPage = 1, $recordsPerPage = 15, $search = ''){
	    ...
	    $display = "SELECT * FROM submission WHERE scholar_id = '$id' $searchQuery ORDER BY sub_date LIMIT $recordsPerPage OFFSET $offset";
	                    ...
	                    <td class="wrap" style="width:100%">
							<div class="icon">
								...
								<span> <ion-icon name="eye-outline" onclick="openPrev(this)" 
									data-scholar_id="'.$row["scholar_id"].'"
						...
						<td style="text-align: right;" class="wrap"> 
							<div class="icon">
								...
								<span> <ion-icon name="eye-outline" onclick="openPrev(this)" 
									...
									data-doc_status="'.$row["doc_status"].'"></ion-icon> </span>
							</div>
...
//* DOCUMENT APPROVAL *//
	if (isset($_POST['approve'])) {
		...
		$update = "UPDATE submission SET doc_status = '$status' WHERE submit_id = '$doc_id'";
